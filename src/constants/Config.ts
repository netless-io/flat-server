...
export const StorageService = {
    ...
    oss: {
        [Region.CN_HZ]: {
            ...
            accessKeySecret: config.storage_service.oss.zh_hz.access_key,
        ...
        [Region.US_SV]: {
            ...
            accessKeySecret: config.storage_service.oss.us_sv.access_key,
        ...
        [Region.SG]: {
            ...
            accessKeySecret: config.storage_service.oss.sg.access_key,
        ...
        [Region.IN_MUM]: {
            ...
            accessKeySecret: config.storage_service.oss.in_mum.access_key,
        ...
        [Region.GB_LON]: {
            ...
            accessKeySecret: config.storage_service.oss.gb_lon.access_key,
