...
export const generateRTM = async (req: Request, res: Response, next: Next): Promise<void> => {
    ...
    const token = RtmTokenBuilder.buildToken(Agora.APP_ID, Agora.APP_CERTIFICATE, uid, RtmRole.Rtm_User, 0);
...
export const generateRTMValidationRules: HTTPValidationRules = {
    body: ["uid"],
};
