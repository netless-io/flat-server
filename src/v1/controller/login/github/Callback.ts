...
<body>
    <svg style=max-width:40vw;max-height:40vh;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
...
<script>
    setTimeout(function(){window.open('x-agora-flat-client://open')}, 1e3);
</script>
</html>
`;
